...
/**
 * @author trey.kirk
 * A convenience class that allows me to run a class stand-alone without having
...
public class RequestExecutorWrapper {
	 ...
	 * @param args
	 */
	public void execute(SailPointContext ctx, Class taskExecutor, Request request, Attributes<String, Object> attr) {
		// TODO Auto-generated method stub
		// First argument specifies the name of the Spring config file

		// Set your task here
		try {
			RequestExecutor task = (RequestExecutor)taskExecutor.newInstance();
