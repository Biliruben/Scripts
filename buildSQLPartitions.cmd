...
set SQL_PART=select acctId, empId, firstName, lastName, middleInit, title, region, department, email, manager from scaleidentity_180k left join scaleidentity_180k_mgr on employee = acctId where acctId like 'SQL_PART_REPLACE%%' order by acctId
