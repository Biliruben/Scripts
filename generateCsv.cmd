...
rem set CLASSPATH=%CLASSPATH%;%JARPATH%\CSVGenerator_1.31.jar
rem set CLASSPATH=%CLASSPATH%;%JARPATH%\CSVGenerator_1.32.jar
set CLASSPATH=%CLASSPATH%;%JARPATH%\CSVGenerator_1.34.jar
