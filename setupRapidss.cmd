...
@echo %doEcho%
set ERROR_MSG=
if "%~1"=="" set ERROR_MSG=Two parameters must be passed: The AP Version and the Bug Number
if "%~2"=="" set ERROR_MSG=Two parameters must be passed: The AP Version and the Bug Number
...
rem Unlike our predecessor setupJira, this script is less ambiguous about the target repo and other bits
set REPO_HOME=%GIT_HOME%\%RAPID_SS_REPO%
