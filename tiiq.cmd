...
rem like L4j
rem set CLASSPATH=%CLASSPATH%;c:\scripts\lib\TreyConsole_8.0_0.13.jar
rem set CLASSPATH=%CLASSPATH%;c:\GITRoot\sp-toolset\bin
...
rem set CLASSPATH=%CLASSPATH%;..\lib\connector-bundle-identityiq.jar
